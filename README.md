...
[**connect**](https://bitbucket.org/gotoh/connect/src/) [[binary file download here]](https://raw.github.com/springlie/smart_switcher/master/connect) is required if proxy is supported in **ssh** and **git**. You can install it easily in path `/usr/bin/connect`.
